...
import { R2_UPLOAD_ERROR_CODES, R2UploadError, uploadMultipleToR2, uploadToR2 } from '@/utils/r2-upload'
 ...
 * @returns Hook 返回值
 */
export function useR2Upload(options: UseR2UploadOptions = {}): UseR2UploadReturn {
